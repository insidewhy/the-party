...
var Objects = exports.Objects = function () {
    function Objects(opts) {
      this.opts = opts;
      this.hash = {};
    }
    Objects.prototype._parseSource = function (objectModule, source) {
    ...
    Objects.prototype.compileSources = function (sources) {
    ...
    Objects.prototype.compileUnresolvedDeps = function () {
      var ret = [];
    ...
    Objects.prototype._buildSourceCodeFromAst = function (object) {
    ...
    Objects.prototype.wrapBodiesInDefine = function () {
      Object.keys(this.hash).forEach(function (objectModule) {
